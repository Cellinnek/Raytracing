...
global_variable int gw = 600, gh=600;
...
LRESULT CALLBACK window_callback(HWND hwdn, UINT uMsg, WPARAM wParam, LPARAM lParam) {
	LRESULT result = 0;
	...
	switch (uMsg) {
		...
		default: {
			result = DefWindowProc(hwdn, uMsg, wParam, lParam);
		}
	}
	return result;
}
